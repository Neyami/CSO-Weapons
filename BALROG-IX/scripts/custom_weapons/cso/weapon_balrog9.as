...
class weapon_balrog9 : ScriptBasePlayerWeaponEntity
{
	...
	bool GetItemInfo( ItemInfo& out info )
	{
		...
		info.iSlot			= BALROG9_SLOT-1;
		info.iPosition		= BALROG9_POSITION-1;
...
void CSO_RegisterWeapon_BALROG9()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_balrog9", "weapon_balrog9" );
