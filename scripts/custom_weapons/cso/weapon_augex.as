...
const string MODEL_WORLD							= "models/custom_weapons/cso/augex/w_augex.mdl";
...
class weapon_augex : CBaseCSOWeapon
{
	...
	void SecondaryAttack()
	{
		...
		//{ event 5001 0 "#I12 S0.12 R2 F0 P30 T0.12 A1 L0 O0" } 
		MuzzleflashCSO( 3, "#I12 S0.12 R2 F0 P30 T0.12 A1 L0 O0" );
	}
