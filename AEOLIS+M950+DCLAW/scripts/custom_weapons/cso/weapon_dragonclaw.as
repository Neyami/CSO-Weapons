...
const float DCLAW_TIME_DEPLOY			= 1.2f;
...
class weapon_dragonclaw : ScriptBasePlayerWeaponEntity
{
	...
	bool Deploy()
	{
		bool bResult;
		{
			...
			self.m_flTimeWeaponIdle = self.m_flNextPrimaryAttack = self.m_flNextSecondaryAttack = g_Engine.time + DCLAW_TIME_DEPLOY;
...
void CSO_RegisterWeapon_DRAGONCLAW()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_dragonclaw", "weapon_dragonclaw" );
